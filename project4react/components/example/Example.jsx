      ...
      <div className="container Example">
        <h1>CS142 Project#4 React.js Example</h1>
          <div className="cs142-example-output">
            <label htmlFor="mottog">Input: </label>
            <input in="mottog" type="text" value={this.state.motto} onChange={this.handleChangeBound}/>
          </div>
        <div className="motto-update">
          {/* Your problem #1 motto displaying and updating widget goes here */}
          <div className="mottog">{this.state.motto}</div>
        </div>
